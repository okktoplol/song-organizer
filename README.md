...
- use the option ```--create-script``` if you'd like a bash script with the changes instead of being prompted to apply them, this will output a ```rename.sh``` file and you can ```chmod +x``` it and run it to apply the changes (TODO)
